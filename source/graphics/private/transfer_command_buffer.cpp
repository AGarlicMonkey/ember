...
namespace ember::inline graphics {
    ...
    void transfer_command_buffer::copy_buffer_to_image(buffer const *const source, std::size_t const source_offset, image const *const destination, vec3u const destination_offset, vec3u const destination_extent, std::uint32_t const destination_base_layer, std::uint32_t const destination_layer_count) {
    ...
    void transfer_command_buffer::copy_image_to_buffer(image const *const source, vec3i const source_offset, vec3u const source_extent, std::uint32_t const source_base_layer, std::uint32_t const source_layer_count, buffer const *const destination, std::size_t const destination_offset) {
